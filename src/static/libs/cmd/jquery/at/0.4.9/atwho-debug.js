define("jquery/at/0.4.9/atwho-debug", [ "jquery/caret/0.0.8/caret-debug", "$-debug" ], function(require, exports, module) {
    require("jquery/caret/0.0.8/caret-debug");
...
*/
    (function() {
        (function(factory) {
            ...
            var $CONTAINER, Api, App, Atwho, Controller, DEFAULT_CALLBACKS, KEY_CODE, Model, View, __slice = [].slice;
            App = function() {
