...
(function(factory) {
    ...
    $.Widget.prototype = {
        ...
        destroy: function() {
            ...
            this.widget().unbind(this.eventNamespace).removeAttr("aria-disabled").removeClass(this.widgetFullName + "-disabled " + "state-disabled");
        ...
        _setOption: function(key, value) {
            ...
            if (key === "disabled") {
                this.widget().toggleClass(this.widgetFullName + "-disabled state-disabled", !!value).attr("aria-disabled", value);
                this.hoverable.removeClass("state-hover");
                this.focusable.removeClass("state-focus");
            }
            return this;
        ...
        _on: function(suppressDisabledCheck, element, handlers) {
            ...
            $.each(handlers, function(event, handler) {
                function handlerProxy() {
                    ...
                    if (!suppressDisabledCheck && (instance.options.disabled === true || $(this).hasClass("state-disabled"))) {
                        return;
                    }
