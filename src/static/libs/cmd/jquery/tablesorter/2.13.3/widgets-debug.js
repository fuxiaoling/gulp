define("jquery/tablesorter/2.13.3/widgets-debug", [ "$-debug" ], function(require, exports, module) {
    ...
    (function($) {
        ...
        ts.themes = {
            ...
            jui: {
                table: "widget widget-content corner-all",
                // table classes
                caption: "widget-content corner-all",
                header: "widget-header corner-all state-default",
                // header classes
                footerRow: "",
                footerCells: "",
                icons: "icon",
                // icon class added to the <i> in the header
                sortNone: "icon-carat-2-n-s",
                sortAsc: "icon-carat-1-n",
                sortDesc: "icon-carat-1-s",
                active: "state-active",
                // applied when column is sorted
                hover: "state-hover",
                // hover class
