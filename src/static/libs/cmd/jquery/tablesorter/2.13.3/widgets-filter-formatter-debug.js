define("jquery/tablesorter/2.13.3/widgets-filter-formatter-debug", [ "$-debug" ], function(require, exports, module) {
            ...
            uiSlider: function($cell, indx, sliderDef) {
                ...
                updateSlider = function(ui) {
                    ...
                    if (o.valueToHeader) {
                        ...
                        $cell.find(".slider-handle").addClass("value-popup").attr("data-value", result);
                    }
                    ...
                    if ($shcell.length) {
                        ...
                        if (o.valueToHeader) {
                            ...
                            $shcell.find(".slider-handle").addClass("value-popup").attr("data-value", result);
                        }
                    }
                };
                $cell.closest("thead").find("th[data-column=" + indx + "]").addClass("filter-parsed");
            ...
            uiRange: function($cell, indx, rangeDef) {
                ...
                updateUiRange = function(ui) {
                    ...
                    if (o.valueToHeader) {
                        ...
                        // add values to the handle data-value attribute so the css tooltip will work properly
                        $cell.find(".slider-handle").addClass("value-popup").eq(0).attr("data-value", val[0]).end().eq(1).attr("data-value", val[1]);
                    }
                    // update the hidden input
                    ...
                    if ($shcell.length) {
                        ...
                        if (o.valueToHeader) {
                            ...
                            $shcell.find(".slider-handle").addClass("value-popup").eq(0).attr("data-value", val[0]).end().eq(1).attr("data-value", val[1]);
                        }
                    }
                };
                $cell.closest("thead").find("th[data-column=" + indx + "]").addClass("filter-parsed");
