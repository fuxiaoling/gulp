...
require.config({
    ...
    //公共模块输出变量名
    paths: {
        '$': _URL.libsUrl + '/zepto/1.1.6/zepto', //http://www.css88.com/doc/zeptojs/
        'zepto':  _URL.libsUrl + '/zepto/1.1.6/zepto',
        'Zepto':  _URL.libsUrl + '/zepto/1.1.6/zepto',
        'msui':  _URL.libsUrl + '/msui/0.6.2/sm', //http://m.sui.taobao.org/components/
        'msuiExtend':  _URL.libsUrl + '/msui/0.6.2/sm-extend', //http://m.sui.taobao.org/extends/
